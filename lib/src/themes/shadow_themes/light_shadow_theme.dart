...
class LightShadowTheme extends ShadowTheme {
  LightShadowTheme(BaratitoPalette palette) : super(palette);

  @override
  BoxShadow get large => BoxShadow(
        blurRadius: 64,
        color: palette.purple.withOpacity(.1),
      );
  ...
  BoxShadow get small => BoxShadow(
        blurRadius: 16,
        offset: Offset(0, 8),
        color: palette.purple.withOpacity(.2),
      );
}
